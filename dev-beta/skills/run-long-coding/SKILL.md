...
This is an experimental `dev-beta` capability. Coordinate from the main session without creating a
...
task closure; the user must separately decide whether to invoke `close-change`.
