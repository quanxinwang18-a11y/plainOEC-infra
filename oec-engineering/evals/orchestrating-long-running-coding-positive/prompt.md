---
name: orchestrating-long-running-coding-positive
description: Routes an explicit long-running Web application change to the intended manual Skill.
tags: [routing, positive, orchestrating-long-running-coding]
max_turns: 10
timeout_seconds: 300
allowed_tools: [Read, Glob, Grep, Skill]
---

使用 /oec-engineering:orchestrating-long-running-coding 继续现有的
