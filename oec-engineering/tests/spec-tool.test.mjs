...
async function validFixture() {
  ...
  await writeFiles(workspace, {
    'ai-docs/engineering/README.md': `# Engineering knowledge
...
`,
    'ai-docs/engineering/specs/repository.md': `---
id: SPEC-repository
applies_to:
  - "**"
---
...
`,
    'ai-docs/engineering/specs/modules/search.md': `---
id: SPEC-search
applies_to:
  - services/search/**
---
...
`,
    'ai-docs/engineering/decisions/ADR-0001-payment-boundary.md': `---
id: ADR-0001
status: accepted
date: 2026-08-20
supersedes: []
...
test('check reports deterministic contract failures', async () => {
  const workspace = await validFixture();
  await writeFiles(workspace, {
    'ai-docs/engineering/specs/duplicate.md': `---
id: SPEC-payment-domain
applies_to:
  - ../outside/**
---
...
# Duplicate
`,
    'ai-docs/engineering/decisions/ADR-0002-new-boundary.md': `---
id: ADR-0002
status: accepted
date: 2026-08-20
supersedes:
...
# New boundary
`,
    'ai-docs/engineering/changes/invalid/change.md': `---
id: another-id
related_specs:
  - SPEC-missing
---
...
`,
  ...
  const index = join(workspace, 'ai-docs/engineering/README.md');
