...
The first migration stage exposes the four existing PRD publication tools. The Plugin is not added
to the Marketplace until the Product dependency cutover, so normal installations cannot load both
the legacy embedded Server and this Server.
